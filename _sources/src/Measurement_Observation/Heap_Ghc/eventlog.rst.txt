...
.. note::
   The heap profile is not a static image! Feel free to click through the
   interactive output from eventlog2html
...
Each chart serves different purposes and each are useful, let's quickly go
through them:
